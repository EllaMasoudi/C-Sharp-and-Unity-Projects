...
function get_todos(){
    ...
    communicate with the web browser to make the task a javascript obj*/
    if (todos_str !== null){
...
function show() {
    ...
    for (var i = 0; i < todos.length; i++){
        /*this also displays the task as a list and creates th button with the"x" */
...
/*this display input task when the Add Item button is clicked*/
